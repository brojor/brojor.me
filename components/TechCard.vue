...
<template>
  <li ref="card">
    <NuxtLink :to="item.url" target="_blank" class="relative h-[98px] w-[98px] flex-center rounded-lg bg-black/20 md:h-[113px] md:w-[113px] dark:bg-white/20">
      ...
      <figure class="relative z-2 h-full w-full flex flex-col justify-center border border-black/20 rounded-[7px] hoverable:h-[calc(100%-2px)] hoverable:w-[calc(100%-2px)] dark:border-white/20 hoverable:border-none bg-default" style="--un-bg-opacity: 90%">
